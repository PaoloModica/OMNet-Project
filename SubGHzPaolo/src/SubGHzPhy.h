#ifndef __SUBGHZPAOLO_SUBGHZPHY_H_
#define __SUBGHZPAOLO_SUBGHZPHY_H_
...
class INET_API SubGHzPhy : public ChannelAccess, public ILifecycle
{
    public:
    ...
    // message handle functions
        ...
        virtual SubGHzRadioModel *createRadioModel() { return (SubGHzRadioModel *) createOne(par("radioMod").stringValue()); }
  ...
  protected:
        ...
        SubGHzRadioModel* radioMod;                  //questa
